...
==============================================
Zdrojový kód: 13_Cykly_Prezentace
*/
...
int main() // Hlavní funkce programu, kde se provádí kód.
{
    ...
    {
        // Vykreslení prvního trojúhelníku (a)
        for (int j = 1; j <= vyska; j++) // Vnitřní smyčka řídí počet znaků v každém řádku.
        {
        ...
        // Vykreslení druhého trojúhelníku (b)
        for (int j = 1; j <= vyska; j++) // Opět vnitřní smyčka pro řízení počtu znaků na každém řádku.
        {
